 ...
 *
 */
public class BuyItAgainSearchPagePopulator<QUERY, STATE, RESULT, ITEM extends BuyItAgainData, SCAT, CATEGORY>
		implements Populator<BuyItAgainSearchPageData<QUERY, RESULT>, BuyItAgainSearchPageData<STATE, ITEM>>
{
	...
	@Override
	public void populate(final BuyItAgainSearchPageData<QUERY, RESULT> source, final BuyItAgainSearchPageData<STATE, ITEM> target)
