...
public class NearbyStoreSearchPagePopulator<QUERY, STATE, RESULT, ITEM extends PointOfServiceData, SCAT, CATEGORY>
        implements Populator<NearbyStoreSearchPageData<QUERY, RESULT>, NearbyStoreSearchPageData<STATE, ITEM>>
{
    ...
    @Override
    public void populate(final NearbyStoreSearchPageData<QUERY, RESULT> source, final NearbyStoreSearchPageData<STATE, ITEM> target)
