 ...
 *
 */
public class ListSearchPagePopulator<QUERY, STATE, RESULT, ITEM extends SavedListEntryData, SCAT, CATEGORY>
		implements Populator<ListSearchPageData<QUERY, RESULT>, ListSearchPageData<STATE, ITEM>>
{
	...
	@Override
	public void populate(final ListSearchPageData<QUERY, RESULT> source, final ListSearchPageData<STATE, ITEM> target)
