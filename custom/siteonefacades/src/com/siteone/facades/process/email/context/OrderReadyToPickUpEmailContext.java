 ...
 *
 */
public class OrderReadyToPickUpEmailContext<BusinessProcessModel>
		extends AbstractEmailContext<OrderReadyToPickUpEmailProcessModel>
{


	private static final Logger LOG = Logger.getLogger(OrderReadyToPickUpEmailContext.class);
	...
	@Override
	public void init(final OrderReadyToPickUpEmailProcessModel businessProcessModel, final EmailPageModel emailPageModel)
	{
	...
	@Override
	protected BaseSiteModel getSite(final OrderReadyToPickUpEmailProcessModel businessProcessModel)
	{
	 ...
	 */
	@Override
	protected CustomerModel getCustomer(final OrderReadyToPickUpEmailProcessModel businessProcessModel)
	{
		// YTODO Auto-generated method stub
		return null;
	}
	 ...
	 */
	@Override
	protected LanguageModel getEmailLanguage(final OrderReadyToPickUpEmailProcessModel businessProcessModel)
	{
		// YTODO Auto-generated method stub
