 ...
 *
 */
public class CustomerUpdateNewEmailContext extends AbstractEmailContext<CustomerUpdateNewEmailProcessModel>
{
	private static final Logger LOG = Logger.getLogger(CustomerUpdateNewEmailContext.class);
	...
	@Override
	public void init(final CustomerUpdateNewEmailProcessModel businessProcessModel, final EmailPageModel emailPageModel)
	{
		...
		LOG.info("CustomerUpdateNewEmailContext");
		...
		//put(FROM_EMAIL, emailPageModel.getFromEmail());
		put(EMAIL, businessProcessModel.getNewEmail());
		//put(EMAIL, Config.getString("siteone.support.email", null));
		put(FROM_DISPLAY_NAME, emailPageModel.getFromName());

		/*
		 * put(FIRST_NAME, businessProcessModel.getFirstName()); put(LAST_NAME, businessProcessModel.getLastName());
	...
	@Override
	protected BaseSiteModel getSite(final CustomerUpdateNewEmailProcessModel businessProcessModel)
	{
		return businessProcessModel.getSite();
	}

	@Override
	protected CustomerModel getCustomer(final CustomerUpdateNewEmailProcessModel businessProcessModel)
	{
		return null;
	}
	...
	@Override
	protected LanguageModel getEmailLanguage(final CustomerUpdateNewEmailProcessModel businessProcessModel)
	{
