 ...
 *
 */
public class SDSSearchResponseQueryPopulator<FACET_SEARCH_CONFIG_TYPE, INDEXED_TYPE_TYPE, SEARCH_QUERY_TYPE, SEARCH_RESULT_TYPE, ITEM>
		implements
		Populator<SolrSearchResponse<FACET_SEARCH_CONFIG_TYPE, INDEXED_TYPE_TYPE, IndexedProperty, SEARCH_QUERY_TYPE, IndexedTypeSort, SEARCH_RESULT_TYPE>, FacetSearchPageData<SolrSearchQueryData, ITEM>>
{
	...
	{
		{
			return buildSearchQueryData(source.getRequest().getSearchText(),
					source.getRequest().getSearchQueryData().getCategoryCode(), source.getRequest().getIndexedPropertyValues(),
