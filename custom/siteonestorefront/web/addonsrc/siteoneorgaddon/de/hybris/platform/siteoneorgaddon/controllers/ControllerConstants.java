 ...
 */
package de.hybris.platform.siteoneorgaddon.controllers;
...
public interface ControllerConstants
{
    ...
    interface Views
    {
        interface Pages
        {
            interface Error
            {
                String ErrorNotFoundPage = "pages/notfound/notFoundPage";
            }
            ...
            interface MyCompany
            {
                ...
                String MyCompanyManageUsersShipToPagePopup = VIEW_PAGE_PREFIX + "pages/company/myCompanyManageUsersShipToPagePopup";
            }
        }
    }
}
