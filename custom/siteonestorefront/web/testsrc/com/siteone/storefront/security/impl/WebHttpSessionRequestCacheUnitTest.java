...
//				Mockito.argThat(new DefaultSavedRequestArgumentMatcher("some blah")));
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/siteonestorefront/electronics/en",
						"https://electronics.local:9002/siteonestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/siteonestorefront/electronics/en",
						"https://electronics.local:9002/siteonestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/siteonestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/siteonestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/siteonestorefront/electronics/en",
						"https://electronics.local:9002/siteonestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/siteonestorefront",
						"https://electronics.local:9002/siteonestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/siteonestorefront",
						"https://electronics.local:9002/siteonestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/siteonestorefront/electronics/en",
						"https://electronics.local:9002/siteonestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
