    ...
    $.extend(Fastsearch.prototype, {
        ...
        documentCancelEvents: function(setup, onCancel) {
            ...
            if (setup === 'off' && this.closeEventsSetuped) {
                ...
                $document.on(this.namespaceEvents('click keyup touchend'), function(e) {
    ...
    $.extend(Fastselect.prototype, {
        ...
        setupEvents: function() {
            ...
            if (this.isMultiple) {
                ...
                }).on(this.namespaceEvents('blur'), function() {
                	/*self.fastsearch.$resultsCont.remove();
                    delete self.fastsearch.$resultsCont;*/
                    //self.hide();
