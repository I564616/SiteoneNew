...
<!--<c:if test="${product.stock.isHomeStoreStockAvailable}">
<div class="col-xs-12 col-md-12 btn-algnmnt">
<button class="btn btn-primary btn-block btn-carousel_addtocart">Add to Cart</button>
</div>
</c:if>-->