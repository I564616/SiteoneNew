...
<%@ attribute name="isNotInStockProd" required="true" type="java.lang.String" %>
 <input type="hidden" class="isNotAvailableListValue" value="${isNotInStockProd}" />
...
<!-- When  Create New List Button is clicked, popup will open with below HTML -->
...
<div class="add-to-list-container hidden-sm hidden-xs">
    <form:form class="wishlistForm" id="wishlistForm${product.code}">
        <div class="col-sm-12 listdropdown">
            ...
            <input type="hidden" class="wishListName" name="wishListName" />
            <div class="dropdown">
                <a class="dropdown-label dropdown-toggle signInOverlay removesignInlink" data-toggle="dropdown" aria-haspopup="true"
                ...
                <ul class="wishListDropdown dropdown-menu dropdown-menu-right">
                    <div class="wishlistItemsSection">
                        <c:forEach var="wishListItemObj" items="${allWishlist}">
