...
<c:if test="${(not product.multidimensional || product.variantCount == 1) && (sellableUomListLen==1 || (product.sellableUomsCount>=1))}">
    ...
    <ycommerce:testId code="addToCartButton">
        ...
        <!--Regulated Product - Stock Message - Flags - Commented
