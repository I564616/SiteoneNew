				...
				<div class="store-navigation">
					...
					<div class="pickup-search-product">
						<div class="pickup-search-bar">
							<form:form name="pickupInStoreForm" id="pickupInStoreForm" action="${pickUpInStoreFormAction}" method="post" class="searchPOSForm clearfix">
								<div class="input-group">
									<input type="text"  aria-label="searchLocation" class="form-control"  name="locationQuery" data-id="locationForSearch" placeholder="<spring:theme code="pickup.search.message" />" />
