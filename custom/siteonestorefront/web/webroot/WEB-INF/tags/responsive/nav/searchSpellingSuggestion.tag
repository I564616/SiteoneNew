...
<input type="hidden" id="search" value="${searchPageData.freeTextSearch}"/>
<input type="hidden" id="suggestion" value="${spellingSuggestion.suggestion}"/>
	<div class="searchSpellingSuggestionPrompt" style="display:none">
