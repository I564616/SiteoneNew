...
<%@ attribute name="searchPageData" required="true" type="com.siteone.facade.EventSearchPageData" %>
    ...
    <ul class="pagination">
        ...
        <c:if test="${hasPreviousPage}">
            <li class="pagination-prev">
                ...
                <a href="${previousPageUrl}" rel="prev" class="previous-link">&#8592;&nbsp;<spring:theme code="eventPageSelectionPagination.previous" />
</a>
                </ycommerce:testId>
            </li>
        </c:if>
        ...
        <c:if test="${!hasPreviousPage}">
        <li class="pagination-prev disabled previous-link">&#8592;&nbsp;<spring:theme code="eventPageSelectionPagination.previous" />
</li>
        </c:if>
        ...
        <c:if test="${hasNextPage}">
            <li class="pagination-next">
                ...
                <ycommerce:testId code="searchResults_nextPage_link">
                    <a href="${nextPageUrl}" rel="next" class="next-link"><spring:theme code="eventPageSelectionPagination.previous.next" />
&nbsp;&#8594;</a>
                </ycommerce:testId>
            </li>
        </c:if>
        ...
        <c:if test="${!hasNextPage}">
            <li class="pagination-next disabled next-link"><spring:theme code="eventPageSelectionPagination.previous.next" />
&nbsp;&#8594;</li>
        </c:if>
    </ul>
