    ...
    <ul class="pagination">
        <c:if test="${hasPreviousPage}">
            <li class="pagination-prev">
                ...
                <c:choose>
                    <c:when test="${cmsPage.uid eq 'accountOrdersPage' || cmsPage.uid eq 'invoicelistingpage'}">
                    ...
                    <c:when test="${cmsPage.uid eq 'detailsSavedListPage'}">
                    	<a href="${previousPageUrl}${urlParameters}" rel="prev" class="previous-link saved-list-previous-link">&#8592;</a>
                    </c:when>
                    <c:otherwise>
                    <a href="${previousPageUrl}${urlParameters}" rel="prev" class="previous-link">&#8592;</a>
                    </c:otherwise>
               </c:choose>
        ...
        <c:if test="${cmsPage.uid eq 'searchGrid' || cmsPage.uid eq 'productGrid' || cmsPage.uid eq 'search' || cmsPage.uid eq 'accountOrdersPage' || cmsPage.uid eq 'invoicelistingpage' ||  cmsPage.uid eq 'ewalletdetailspage'}">
            ...
            <li class="empty-pagination" style="display: inline-block !important;">...</li>
            </c:when>
            <c:otherwise>
            ...
            <li class="pagination-next">
                ...
                <ycommerce:testId code="searchResults_nextPage_link">
                    ...
                    <c:when test="${cmsPage.uid eq 'detailsSavedListPage'}">
                    	<a href="${nextPageUrl}${urlParameters}" rel="next" class="next-link saved-list-next-link">&#8594;</a>
                    </c:when>
                    <c:otherwise>
                    <a href="${nextPageUrl}${urlParameters}" rel="next" class="next-link">&#8594;</a>
                    </c:otherwise>
               </c:choose>
