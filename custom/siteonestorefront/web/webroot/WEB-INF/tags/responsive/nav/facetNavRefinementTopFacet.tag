...
<c:if test="${(not empty facetData.values) && (facetData.code eq 'socategory' || facetData.code eq 'soproductBrandNameFacet' || facetData.code eq 'price' || facetData.code eq 'sopriorityBrandNameFacet' || facetData.code eq 'socouponFacet')}">
										...
										<form action="#" method="get">
											...
											<label>
												...
												<span class="facet__list__label">
													<span class="facet__list__mark"></span>
													<span class="facet__list__text">
														<span class="facetWordOverflow">${facetValue.name}&nbsp;
															<ycommerce:testId code="facetNav_count">
																<span class="facet__value__count">
																	${facetValue.count}
																</span>
