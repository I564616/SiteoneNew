...
<%@ attribute name="greenFill" required="false" type="java.lang.String" %>

<svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height}" viewBox="0 0 36.398 18">
	<g transform="translate(-362.938 -141.335)">
		<g transform="translate(362.938 145.424)">
			<path class="selected-fill ${greenFill}" fill=${iconColor}
