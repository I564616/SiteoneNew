...
<%@ taglib prefix="header" tagdir="/WEB-INF/tags/addons/siteonepunchoutaddon/responsive/common/header"%>
<%@ taglib prefix="footer" tagdir="/WEB-INF/tags/addons/siteonepunchoutaddon/responsive/common/footer"%>
