...
{ "recommendedProductsLayer":"<spring:escapeBody javaScriptEscape="true">
	<c:if test="${algonomyRecommendationEnabled}">
		<c:if test="${not empty recentProductsrr2 and recentProductsrr2.size() gt 1}">
			<div class="p-a-25 p-a-15-xs p-a-15-sm owl-theme dashboard-carousel-recently">
				<c:forEach items="${recentProductsrr2}" var="product" varStatus="status">
