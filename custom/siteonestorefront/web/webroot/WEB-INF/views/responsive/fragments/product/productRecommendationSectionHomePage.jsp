					...
					<%-- <h3 class="text-center margin20 black-title"><spring:theme code="text.featured.products"/></h3> --%>
						<div class="facet js-facet">
							<div class="facet__list js-facet-list">
								...
								<c:forEach items="${recommendedProducts}" var="product" varStatus="status"><div class="category-tile-item ${(status.index >3)? 'hidden-md hidden-lg' : ''}"><product:featureProductListerHT product="${product}" isrc="${isrc}" loop="${status.index}"/></div></c:forEach>
							</div>
						</div>
					</div>
				</div>
