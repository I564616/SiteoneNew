...
{ "recommendedProductsLayer":"<spring:escapeBody javaScriptEscape="true">
	<c:if test="${algonomyRecommendationEnabled}">
		<c:if test="${not empty recomProductsrr3 and recomProductsrr3.size() gt 1}">
			<div class="p-a-25 p-a-15-xs p-a-15-sm owl-theme dashboard-carousel-recommended">
				<c:forEach items="${recomProductsrr3}" var="product" varStatus="status">
