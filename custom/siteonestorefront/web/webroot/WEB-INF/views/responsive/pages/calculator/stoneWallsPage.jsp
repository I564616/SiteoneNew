...
<div id="materialsCalculators" class="hidden-xs hidden-sm materialsCalculators">
	<div class="col-md-12 col-xs-12 flex padding0 matCalpart1">
			<img alt="SiteOne Logo" src="/_ui/responsive/theme-lambda/images/stonewalls.png" >
			<div class="row overlay-bcontent col-md-offset-1  m-t-50">
				<div class=""><common:calculatoricon /><span class="matcalpart-text" >How much should I get?</span></div>
				<h1 class="matcal-heading">Stone Walls</h1>
				<div class="col-md-6 padding0 matcal-desc">This calculator will help you figure out how much product you need to complete your project. 
                </div>
			</div>
	</div>
	<div class="cl"></div>
	<div id="flagStoneCalc" class="col-md-10 col-md-offset-1">
	 <div id="flagstone_left_section">
        <div class="row m-b-25 dropdown" style="margin-bottom: 35px">
             <label for="thickness" style="width: inherit !important;"
                class="col-md-4 control-label margin0">Stone Wall Thickness</label>
			<button class="col-md-12 btn btn-default select-option dropdown-toggle" style="padding-left:24px"type="button" id="thickness"
				data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" value="1">
				1 Foot Boulders, 1 Foot Thick Wall
				<span class="glyphicon glyphicon-chevron-down"></span> 
			</button>
            <ul id="thicknessDropdown" class="col-md-12 dropdown-menu dropdown-menu-fs">
                <li class="selected"><a data-value='1'>1 Foot Boulders, 1 Foot Thick Wall</a></li>
                <li><a data-value='2'>1-2 Foot Boulders, 2 Foot Thick Wall</a></li>
				<li><a data-value='3'>5"-12" Rip-Rap, 8 Inch Thick Wall</a></li>
            </ul>
        </div>
    ...
    <div class="pscal">
    <p>Calculations are estimates and do not account for compaction. Changes in
  landscape elevation and the amount of moisture present may affect coverage and
  the weight of the material.</p>
