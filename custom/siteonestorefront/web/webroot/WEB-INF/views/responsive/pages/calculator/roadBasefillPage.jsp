...
<div class="col-md-12 col-xs-12 flex padding0 matCalpart1">
	<img alt="SiteOne Logo"
		src="/_ui/responsive/theme-lambda/images/RoadBaseFill_img.png">
	<div class="row overlay-bcontent col-md-offset-1 m-t-50">
		...
		<h1 class="matcal-heading">Road Base Fill</h1>
...
<div class="cl"></div>
<template:projectCaclulator type="roadBasefillCalc"
	title="Road Base  Fill Calculator" />
</div>
<common:projectCalculatorMob type="roadBasefillCalc"></common:projectCalculatorMob>
</template:page>