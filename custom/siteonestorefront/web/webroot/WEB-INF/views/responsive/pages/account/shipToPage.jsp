...
<%-- <span align="left">
	<a href="<c:url value="/my-account/account-dashboard"/>"  style="padding-left:10px;"><spring:theme code="text.account.addressBook.dashboard"/></a>
</span> --%>
<span align="left">
	<%-- <a href="<c:url value="/my-account/account-dashboard"/>"  style="padding-left:10px;"><spring:theme code="text.account.addressBook.dashboard"/></a> --%>
</span>
<br/>
<h1 class="headline"><spring:theme code="text.account.shipTos"/></h1>

<div class="cl"></div>
<form:form  id="shiptosearchForm" method='GET' modelAttribute="shiptosearchForm">
<div class="col-md-4">
<div class="row"> 
<div class="input-group-shipTo">
<spring:theme code="shiptosearch.placeholder" var="shiptosearchPlaceholder" />   
<input type="text" id="search-ship-to" name="searchParam" value="${searchParam}" onfocus="this.placeholder = ''" onblur="this.placeholder = '${shiptosearchPlaceholder}'" aria-label="productSearch" maxlength="100" placeholder="${shiptosearchPlaceholder}" class="form-control ship-to-search"/> 
<span class="ship-tosearchbtn"><button class="btn btn-link shipToSearch ship-to-search-btn " type="button" id="shipToSearchBoxButton"><span class="icon-search-grey"></span></button></span>
</div>   
</div>  
</div>
</form:form>
...
<div class="cl"></div>
<input type="hidden" name="sortShhipTo" id="sortShhipTo" value="${sortShhipTo}"/>
<input type="hidden" name="searchParam" id="search-shipto"/>
	<c:choose>
		<c:when test="${not empty searchPageData.results}">
		<p class="shipTolink"><spring:theme code="shipToPage.text" /></p>
		</c:when>
		<c:otherwise>
			<p class="shipTolink"><spring:theme code="shipTo.not.linkedto.account" htmlEscape="false"/></p>
		</c:otherwise>
	</c:choose> 
      ...
      <%--  <c:if test="${not empty searchPageData.results}">
            ...
            <c:when test="${not empty searchPageData.results}">
                ...
                <div class="col-md-12 col-sm-12 title-bar hidden-xs">
                	...
                	<div class="col-md-4 col-sm-4"><div class="col-md-12"><spring:theme code="text.company.manageUnit.column.id.date"/></div></div>
                </div>
			         ...
			         var="viewShipToDetailsUrl" htmlEscape="false">
                            ...
                            <tr class="responsive-table-item account-table-md table-border">
                             ...
                             --%>
                              ...
                              <div class="account-orderhistory-pagination sorting-hidden">
