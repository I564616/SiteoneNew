...
<template:page pageTitle="${pageTitle}">
	...
	<div id="materialsCalculators"
		class=" hidden-xs hidden-sm materialsCalculators">
		<div class="col-md-12 col-xs-12 flex padding0 matCalpart1">
			<img alt="SiteOne Logo"
				src="/_ui/responsive/theme-lambda/images/Bark_Mulch_Calculator_Part2.png">
			<div class="row overlay-bcontent col-md-offset-1 m-t-50">
				...
				<h1 class="matcal-heading">Bark & Mulch</h1>
		...
		<div class="cl"></div>
		<template:projectCaclulator type="barkMulchCalc"
			title="Topsoil Fill Calculator" />
	</div>
	<common:projectCalculatorMob type="barkMulchCalc"></common:projectCalculatorMob>
