 ...
 *
 */
@Controller("SiteOnePartnerPerkParagraphComponentController")
@RequestMapping(value = ControllerConstants.Actions.Cms.SiteOnePartnerPerkParagraphComponent)
public class SiteOnePartnerPerkParagraphComponentController
		extends AbstractAcceleratorCMSComponentController<SiteOnePartnerPerkParagraphComponentModel>
{
	...
	protected void fillModel(final HttpServletRequest request, final Model model,
			final SiteOnePartnerPerkParagraphComponentModel component)
	{
		...
		model.addAttribute("headingline1", component.getHeadline());
		model.addAttribute("headinglineContent", component.getHeadlineContents());
