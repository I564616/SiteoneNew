 ...
 *
 */
@Controller("SiteOnePromotionalResponsiveBannerComponentController")
@RequestMapping(value = ControllerConstants.Actions.Cms.SiteOnePromotionalResponsiveBannerComponent)
public class SiteOnePromotionalResponsiveBannerComponentController
		extends AbstractAcceleratorCMSComponentController<SiteOnePromotionalResponsiveBannerComponentModel>
{
	...
	protected void fillModel(final HttpServletRequest request, final Model model,
			final SiteOnePromotionalResponsiveBannerComponentModel component)
	{
		...
		model.addAttribute("promoText", component.getPromotionalText());
