...
/**
 */
public class SiteoneGreenButtonComponentRenderer implements CMSComponentRenderer<CMSLinkComponentModel>
{
	private static final Logger LOG = Logger.getLogger(SiteoneGreenButtonComponentRenderer.class);
	...
	protected static final PolicyFactory policy = new HtmlPolicyBuilder().allowStandardUrlProtocols().allowElements("a", "span")
			...
			.onElements("a").skipRelsOnLinks("noreferrer").allowAttributes("class").onElements("span").toFactory();
			...
			throws ServletException, IOException
	{
		try
		{
			...
			else
			{
				...
				html.append(" class=\"btn btn-primary col-md-3 col-xs-12 col-sm-12\"");
