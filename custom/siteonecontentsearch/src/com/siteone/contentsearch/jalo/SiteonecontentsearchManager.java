...
/**
 * This is the extension manager of the Siteonecontentsearch extension.
 */
public class SiteonecontentsearchManager extends GeneratedSiteonecontentsearchManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SiteonecontentsearchManager.class);
	 ...
	 */
	public static SiteonecontentsearchManager getInstance()
	{
		return (SiteonecontentsearchManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SiteonecontentsearchConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SiteonecontentsearchManager() // NOPMD 
	{
		LOG.debug("constructor of SiteonecontentsearchManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SiteonecontentsearchManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SiteonecontentsearchManager called, current tenant: {}", getTenant().getTenantID());
	}
