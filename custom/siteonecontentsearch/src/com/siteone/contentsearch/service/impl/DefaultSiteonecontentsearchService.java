...
public class DefaultSiteonecontentsearchService implements SiteonecontentsearchService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSiteonecontentsearchService.class);
	...
	{
		return DefaultSiteonecontentsearchService.class.getResourceAsStream("/siteonecontentsearch/sap-hybris-platform.png");
	}
