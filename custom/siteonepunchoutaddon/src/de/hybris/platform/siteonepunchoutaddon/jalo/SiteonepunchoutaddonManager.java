...
/**
 * This is the extension manager of the Siteonepunchoutaddon extension.
 */
public class SiteonepunchoutaddonManager extends GeneratedSiteonepunchoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SiteonepunchoutaddonManager.class.getName());
	 ...
	 */
	public static SiteonepunchoutaddonManager getInstance()
	{
		return (SiteonepunchoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SiteonepunchoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SiteonepunchoutaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SiteonepunchoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SiteonepunchoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SiteonepunchoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
