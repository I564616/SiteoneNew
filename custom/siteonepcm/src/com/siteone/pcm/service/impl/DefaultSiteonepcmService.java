 ...
 */
package com.siteone.pcm.service.impl;
...
public class DefaultSiteonepcmService implements SiteonepcmService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSiteonepcmService.class);
	...
	{
		return DefaultSiteonepcmService.class.getResourceAsStream("/siteonepcm/sap-hybris-platform.png");
	}
