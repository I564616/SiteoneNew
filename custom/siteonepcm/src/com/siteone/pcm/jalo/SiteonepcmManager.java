...
/**
 * This is the extension manager of the Siteonepcm extension.
 */
public class SiteonepcmManager extends GeneratedSiteonepcmManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SiteonepcmManager.class);
	 ...
	 */
	public static SiteonepcmManager getInstance()
	{
		return (SiteonepcmManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SiteonepcmConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SiteonepcmManager() // NOPMD 
	{
		LOG.debug("constructor of SiteonepcmManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SiteonepcmManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SiteonepcmManager called, current tenant: {}", getTenant().getTenantID());
	}
