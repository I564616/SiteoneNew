...
/**
 * This is the extension manager of the Siteoneintegration extension.
 */
public class SiteoneintegrationManager extends GeneratedSiteoneintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SiteoneintegrationManager.class);
	 ...
	 */
	public static SiteoneintegrationManager getInstance()
	{
		return (SiteoneintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SiteoneintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SiteoneintegrationManager() // NOPMD 
	{
		LOG.debug("constructor of SiteoneintegrationManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SiteoneintegrationManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SiteoneintegrationManager called, current tenant: {}", getTenant().getTenantID());
	}
