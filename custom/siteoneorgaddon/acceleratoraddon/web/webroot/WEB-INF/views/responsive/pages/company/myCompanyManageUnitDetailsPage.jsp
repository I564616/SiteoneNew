...
<div class="col-md-7 col-xs-8">
        <h1 class="headline">
          ...
          <spring:theme code="text.company.manage.units.unitDetails"/>
 ...
 <div class="col-md-5 col-xs-12">
                        <div class="row">
                          <div class="col-md-6 col-xs-4">
                            <a href="${editUnitUrl}" class="edit btn btn-block btn-default">
                    ...
                    <c:when test="${unit.active}">
                        ...
                        <span class="js-action-confirmation-modal disable-link">
                            <ycommerce:testId code="Unit_DisableUnit_button">
                                <a class="btn btn-block btn-primary" href="#" data-action-confirmation-modal-title="<spring:theme code="text.company.manage.units.button.disableUnit"/>"
                        ...
                        <c:choose>
                            <c:when test="${unit.unit.active}">
                                <ycommerce:testId code="Unit_EnableUnit_button">
                                    <a href="${enableUnitUrl}" class="btn btn-block btn-primary" >
        ...
        <div class="account-section-content">
                    <div class="col-sm-6 col-no-padding">
                        <div class="row">
                                <div class="detail-panel">
                                 ...
                                 <div class="detail-panel">
                                   <label> 
                                        <spring:theme code="text.company.unit.name"/></label>
                                    <div class="cl"></div>
                                    <span>
                            ...
                            <c:if test="${not empty unit.unit.uid}">
                                     <div class="detail-panel">
                                        <label> 
                                            <spring:theme code="text.company.unit.parent"/></label>
                                    <div class="cl"></div>
                                        <span>
                            ...
                            <c:if test="${not empty unit.approvalProcessName}">
                                    <div class="detail-panel">
                                        <label> 
                                            <spring:theme code="text.company.unit.approvalProcess"/></label>
                                    <div class="cl"></div>
                                        <span>
            ...
            <div class="account-list">
                    ...
                    <div class="row">
                        <c:forEach items="${unit.addresses}" var="address">
                            <div class="col-xs-12 col-sm-6 col-md-4 card">
                                ...
                                <div class="account-cards-actions pull-left margin20">
                                    <a href="${editUnitAddressUrl}"  title="<spring:theme code='text.company.manage.units.edit'/>">
                                        <span class="glyphicon glyphicon-pencil"></span>
                                    </a>
                                    <span class="js-action-confirmation-modal">
                                        <a href="${removeUnitAddressUrl}"   title="<spring:theme code='text.company.manage.units.remove'/>"
                ...
                <div class="account-list-header margin20">
