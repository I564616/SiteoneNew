...
<template:page pageTitle="${pageTitle}">
    <div class="account-section">
        <div>
            <org-common:listHeadline url="${createUserGroupUrl}" labelKey="text.company.${action}.title" label="text.company.addNewUsergroup" urlTestId="Usergroup_createNew_button"/>
        </div>
        <c:choose>
