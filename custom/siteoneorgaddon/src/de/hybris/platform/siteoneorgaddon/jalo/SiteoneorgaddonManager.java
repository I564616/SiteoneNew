 ...
 */
public class SiteoneorgaddonManager extends GeneratedSiteoneorgaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SiteoneorgaddonManager.class.getName());
	 ...
	 */
	public static SiteoneorgaddonManager getInstance()
	{
		return (SiteoneorgaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
	 ...
	 */
	public SiteoneorgaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SiteoneorgaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SiteoneorgaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SiteoneorgaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
