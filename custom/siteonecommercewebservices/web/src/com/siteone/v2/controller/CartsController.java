...
import com.siteone.exceptions.InvalidPaymentInfoException;
import com.siteone.exceptions.NoCheckoutCartException;
import com.siteone.exceptions.UnsupportedDeliveryModeException;
import com.siteone.exceptions.UnsupportedRequestException;
import com.siteone.order.data.CartDataList;
import com.siteone.order.data.OrderEntryDataList;
import com.siteone.product.data.PromotionResultDataList;
import com.siteone.request.support.impl.PaymentProviderRequestSupportedStrategy;
import com.siteone.stock.CommerceStockFacade;
import com.siteone.voucher.data.VoucherDataList;
...
public class CartsController extends BaseCommerceController
{
	...
	public CartModificationWsDTO createCartEntry(
			...
			@Parameter(description = "Code of the product to be added to cart. Product look-up is performed for the current product catalog version.", required = true) @RequestParam final String code,
			@Parameter(description = "Quantity of product.") @RequestParam(defaultValue = "1") final long qty,
	...
	@PostMapping(value = "/{cartId}/entries", consumes = { MediaType.APPLICATION_JSON_VALUE,
	...
	@GetMapping("/{cartId}/entries/{entryNumber}")
	@ResponseBody
	...
	@PutMapping("/{cartId}/entries/{entryNumber}")
	@ResponseBody
	...
	public CartModificationWsDTO replaceCartEntry(
			@Parameter(description = "Base site identifier.", required = true) @PathVariable final String baseSiteId,
			@Parameter(description = "The entry number. Each entry in a cart has an entry number. Cart entries are numbered in ascending order, starting with zero (0).", required = true) @PathVariable final long entryNumber,
			@Parameter(description = "Quantity of product.", required = true) @RequestParam final Long qty,
			@Parameter(description = "Name of the store where product will be picked. Set only if want to pick up from a store.") @RequestParam(required = false) final String pickupStore,
			@Parameter(description = "Response configuration. This is the list of fields that should be returned in the response body.", schema = @Schema(allowableValues = "BASIC, DEFAULT, FULL")) @RequestParam(defaultValue = DEFAULT_FIELD_SET) final String fields)
			throws CommerceCartModificationException
	{
	...
	@PutMapping(value = "/{cartId}/entries/{entryNumber}", consumes = {
	...
	@PatchMapping("/{cartId}/entries/{entryNumber}")
	@ResponseBody
	...
	@PatchMapping(value = "/{cartId}/entries/{entryNumber}", consumes = {
			MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseBody
	...
	@PutMapping("/{cartId}/addresses/delivery")
	@ResponseStatus(HttpStatus.OK)
	...
	@Secured({ "ROLE_CUSTOMERGROUP", "ROLE_GUEST", "ROLE_CUSTOMERMANAGERGROUP", "ROLE_TRUSTED_CLIENT" })
	@DeleteMapping("/{cartId}/addresses/delivery")
	@ResponseStatus(HttpStatus.OK)
	...
	@Secured({ "ROLE_CUSTOMERGROUP", "ROLE_GUEST", "ROLE_CUSTOMERMANAGERGROUP", "ROLE_TRUSTED_CLIENT" })
	@GetMapping("/{cartId}/deliverymode")
	@ResponseBody
	...
	@Secured({ "ROLE_CUSTOMERGROUP", "ROLE_GUEST", "ROLE_CUSTOMERMANAGERGROUP", "ROLE_TRUSTED_CLIENT" })
	@PutMapping("/{cartId}/deliverymode")
	@ResponseStatus(HttpStatus.OK)
	...
	@Secured({ "ROLE_CUSTOMERGROUP", "ROLE_GUEST", "ROLE_CUSTOMERMANAGERGROUP", "ROLE_TRUSTED_CLIENT" })
	@DeleteMapping("/{cartId}/deliverymode")
	@ResponseStatus(HttpStatus.OK)
	...
	@Secured({ "ROLE_CUSTOMERGROUP", "ROLE_GUEST", "ROLE_CUSTOMERMANAGERGROUP", "ROLE_TRUSTED_CLIENT" })
	@GetMapping("/{cartId}/deliverymodes")
	@ResponseBody
	...
	@Secured({ "ROLE_CUSTOMERGROUP", "ROLE_GUEST", "ROLE_CUSTOMERMANAGERGROUP", "ROLE_TRUSTED_CLIENT" })
	@PostMapping("/{cartId}/paymentdetails")
	@ResponseStatus(HttpStatus.CREATED)
	@ResponseBody
	...
	@Secured({ "ROLE_CUSTOMERGROUP", "ROLE_GUEST", "ROLE_CUSTOMERMANAGERGROUP", "ROLE_TRUSTED_CLIENT" })
	@PutMapping("/{cartId}/paymentdetails")
	@ResponseStatus(HttpStatus.OK)
	...
	@Operation(operationId ="doApplyCartPromotion", summary = "Enables promotions based on the promotionsId of the cart.", description =
			"Enables a promotion for the order based on the promotionId defined for the cart. "
					...
					+ "with the new promotions engine.", security = @SecurityRequirement(name = "oauth", scopes = {"oauth2_client_credentials"}))
	@ApiBaseSiteIdUserIdAndCartIdParam
	...
	@Operation(operationId ="removeCartPromotion", summary = "Disables the promotion based on the promotionsId of the cart.", description =
			"Disables the promotion for the order based on the promotionId defined for the cart. "
					...
					+ "the new promotions engine.", security = @SecurityRequirement(name = "oauth", scopes = {"oauth2_client_credentials"}))
	@ApiBaseSiteIdUserIdAndCartIdParam
	...
	@Secured({ "ROLE_CLIENT", "ROLE_CUSTOMERGROUP", "ROLE_CUSTOMERMANAGERGROUP", "ROLE_TRUSTED_CLIENT", "ROLE_GUEST" })
	@DeleteMapping("/{cartId}/vouchers/{voucherId}")
	@ResponseStatus(HttpStatus.OK)
