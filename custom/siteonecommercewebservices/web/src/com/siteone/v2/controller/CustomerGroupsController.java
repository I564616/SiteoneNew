...
public class CustomerGroupsController extends BaseController
{
	...
	@PatchMapping(value = "/{groupId}/members", consumes = { MediaType.APPLICATION_JSON_VALUE,
	...
	@PutMapping(value = "/{groupId}/members", consumes = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE })
	@Secured("ROLE_CUSTOMERMANAGERGROUP")
	@ResponseStatus(value = HttpStatus.OK)
