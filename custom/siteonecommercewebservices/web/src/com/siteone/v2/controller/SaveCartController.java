...
public class SaveCartController extends BaseCommerceController
{
	...
	@PatchMapping("/{cartId}/restoresavedcart")
	@ResponseBody
	...
	@PatchMapping("/{cartId}/flagForDeletion")
	@ResponseBody
	...
	@PostMapping("/{cartId}/clonesavedcart")
	@ResponseBody
