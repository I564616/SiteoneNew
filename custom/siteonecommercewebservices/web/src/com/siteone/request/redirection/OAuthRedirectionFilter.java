 ...
 */
package com.siteone.request.redirection;
 ...
 *    	<filter-class>com.siteone.request.redirection.OAuthRedirectionFilter</filter-class>
 * 	</filter>
 *
 * 	<filter-mapping>
 * 		<filter-name>oauthRedirectionFilter</filter-name>
...
public class OAuthRedirectionFilter implements Filter
{
			...
			throws IOException, ServletException
	{
		...
		httpResponse.addHeader("Location", StringUtils.normalizeSpace(newUrl)); //NOSONAR
	}
