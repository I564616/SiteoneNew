 ...
 *
 */
public class SiteOneOrderTypeForm
{
	...
	boolean isGuestUser;
	boolean isExpedited;
	private String isSameAsContactInfo;
	...
	/**
	 * @param kountSessionId the kountSessionId to set
	 */
	...
	public void setExpediteDelivery(boolean expediteDelivery) {
	...
	public void setChooseLift(boolean chooseLift) {
	...
	public void setIsSameAsContactInfo(String isSameAsContactInfo) {
