 ...
 */
public class SiteonebackofficeManager extends GeneratedSiteonebackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SiteonebackofficeManager.class.getName());
	 ...
	 */
	public static SiteonebackofficeManager getInstance()
	{
		return (SiteonebackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SiteonebackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SiteonebackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SiteonebackofficeManager called.");
		}
	}
