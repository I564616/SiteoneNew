 ...
 */
public class SiteoneacceleratoraddonManager extends GeneratedSiteoneacceleratoraddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SiteoneacceleratoraddonManager.class.getName());
	 ...
	 */
	public static SiteoneacceleratoraddonManager getInstance()
	{
		return (SiteoneacceleratoraddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
	 ...
	 */
	public SiteoneacceleratoraddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SiteoneacceleratoraddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SiteoneacceleratoraddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SiteoneacceleratoraddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
