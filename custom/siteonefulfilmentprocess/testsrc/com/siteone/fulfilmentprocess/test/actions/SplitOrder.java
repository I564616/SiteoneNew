 ...
 */
package com.siteone.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(SiteoneFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SiteoneFulfilmentProcessConstants.PARENT_PROCESS);
