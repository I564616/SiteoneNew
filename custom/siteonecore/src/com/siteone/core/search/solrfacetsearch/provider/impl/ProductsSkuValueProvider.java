 ...
 *
 */
public class ProductsSkuValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider, Serializable
{
			...
			final Object model) throws FieldValueProviderException
	{

		{
			if (model instanceof ProductModel)
			{
				...
				{
					fieldValues.addAll(createFieldValue(baseProduct.getCode(), indexedProperty));
				}
