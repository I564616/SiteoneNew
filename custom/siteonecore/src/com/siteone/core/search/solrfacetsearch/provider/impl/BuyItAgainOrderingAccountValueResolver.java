 ...
 *
 */
public class BuyItAgainOrderingAccountValueResolver extends AbstractValueResolver<OrderEntryModel, Object, Object>
{
			...
			final ValueResolverContext<Object, Object> valueResolverContext) throws FieldValueProviderException
	{
		...
		document.addField(indexedProperty, orderEntryModel.getOrder().getOrderingAccount().getPath(),
