 ...
 *
 */
public class ProductVariantCountValueProvider extends AbstractPropertyFieldValueProvider
		implements FieldValueProvider, Serializable
{
			...
			final Object model) throws FieldValueProviderException
	{
		if (model instanceof ProductModel)
		{
			...
			{
				fieldValues.addAll(createFieldValue(variants.size(), indexedProperty));
			}
	...
	protected Collection<FieldValue> createFieldValue(final int variantCountValue, final IndexedProperty indexedProperty)
	{
		final List<FieldValue> fieldValues = new ArrayList<>();
		final Collection<String> fieldNames = fieldNameProvider.getFieldNames(indexedProperty, null);
		for (final String fieldName : fieldNames)
		{
			fieldValues.add(new FieldValue(fieldName, variantCountValue));
		}
		return fieldValues;
	}
