 ...
 *
 */
public class CouponEnabledValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider, Serializable
{
			...
			final Object model) throws FieldValueProviderException
	{
		if (model instanceof ProductModel)
		{
			...
			fieldValues.addAll(createFieldValue(couponEnabled, indexedProperty));
			return fieldValues;
		}
		else
		{
	...
	protected Collection<FieldValue> createFieldValue(final boolean couponEnabled, final IndexedProperty indexedProperty)
	{
