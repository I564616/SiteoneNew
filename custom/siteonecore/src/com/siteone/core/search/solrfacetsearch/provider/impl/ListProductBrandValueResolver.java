 ...
 *
 */
public class ListProductBrandValueResolver extends AbstractPropertyFieldValueProvider implements FieldValueProvider, Serializable
{
			...
			final Object model) throws FieldValueProviderException
	{
		...
		final Object brandName = getProductAttribute(listEntry.getProduct(), ProductModel.PRODUCTBRANDNAME);
