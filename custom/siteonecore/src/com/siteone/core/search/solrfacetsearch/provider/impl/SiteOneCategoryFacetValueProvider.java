 ...
 *
 */
public class SiteOneCategoryFacetValueProvider extends CategoryCodeValueProvider
{
			...
			final Object model) throws FieldValueProviderException
	{
		...
		final Collection<CategoryModel> categories = getCategorySource().getCategoriesForConfigAndPropertyForFacet(indexConfig,
