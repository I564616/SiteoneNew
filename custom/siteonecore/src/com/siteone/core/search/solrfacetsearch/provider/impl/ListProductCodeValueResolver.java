 ...
 *
 */
public class ListProductCodeValueResolver extends AbstractValueResolver<Wishlist2EntryModel, Object, Object>
{
			...
			final ValueResolverContext<Object, Object> valueResolverContext) throws FieldValueProviderException
	{
		...
		document.addField(indexedProperty, listEntryModel.getProduct().getCode(), valueResolverContext.getFieldQualifier());
	}
