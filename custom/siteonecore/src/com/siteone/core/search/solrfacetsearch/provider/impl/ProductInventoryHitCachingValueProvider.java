 ...
 *
 */
public class ProductInventoryHitCachingValueProvider extends AbstractProductInventoryCachingValueProvider
		implements FieldValueProvider, Serializable
{
	...
	private boolean isSellableInventoryHit(final IndexProductPosInventoryData inventoryData)
	{
		return  !(inventoryData.getStockLevelFlag()
				&& (inventoryData.getInventoryHitCountFlag() || (null == inventoryData.getInventoryHitCount())) && !inventoryData.getForceInStock());
	}
