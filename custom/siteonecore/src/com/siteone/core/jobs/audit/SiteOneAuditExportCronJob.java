 ...
 */
public class SiteOneAuditExportCronJob extends AbstractJobPerformable<CronJobModel>
{

	private static final Logger LOG = Logger.getLogger(SiteOneAuditExportCronJob.class);
	...
	public PerformResult perform(final CronJobModel cronJob)
	{
		...
		try
		{
			...
			for (final String typeName : tables)
			{
				...
				auditGateway.fetchAuditRecordsForTypeAndDate(typeName, currentDate.getTime());
				LOG.info(" Records fetched from audit table " + typeName);
			}
			LOG.info("finished audit export job");
