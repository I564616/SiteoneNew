...
/**
 * This class for Retrieving the entry number for the order entry
 *
 * @author Ravi-so
 *
 */
public class OrderEntryNumberTranslator extends AbstractValueTranslator
{
	private static final Logger LOG = Logger.getLogger(OrderEntryNumberTranslator.class);
	...
	public Object importValue(final String cellValue, final Item item) throws JaloInvalidParameterException
	{
		...
		return entryModel != null ? entryModel.getEntryNumber() : null;
	}
