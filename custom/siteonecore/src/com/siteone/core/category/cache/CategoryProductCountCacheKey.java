 ...
 *
 */
public class CategoryProductCountCacheKey implements CacheKey
{
    ...
    public CategoryProductCountCacheKey(final String code)
    {
        this.code = code;
    }
    ...
    public boolean equals(final Object obj)
    {
        ...
        final CategoryProductCountCacheKey cacheKey = (CategoryProductCountCacheKey) obj;
