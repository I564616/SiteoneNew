 ...
 *
 */
public class OrderScheduledForDeliveryEvent extends AbstractCommerceUserEvent<BaseSiteModel>
{
	 ...
	 * @param order
	 */
	public OrderScheduledForDeliveryEvent(final OrderModel order, final ConsignmentModel consignment)
	{
		super();
		this.order = order;
