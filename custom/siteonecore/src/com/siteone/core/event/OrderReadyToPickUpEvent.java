 ...
 *
 */
public class OrderReadyToPickUpEvent extends AbstractCommerceUserEvent<BaseSiteModel>
{
	 ...
	 * @param order
	 */
	public OrderReadyToPickUpEvent(final OrderModel order, final ConsignmentModel consignment)
	{
		super();
		this.order = order;
