 ...
 *
 */
public class ContentPageCategoryValueProvider extends AbstractPropertyFieldValueProvider
		implements Serializable, FieldValueProvider
{
			...
			final Object model) throws FieldValueProviderException
	{
		...
		if (model instanceof ContentPageModel)
		{
			...
			if (category != null)
			{
				return createFieldValues(indexedProperty, category);
			}
			else
			{
				LOG.error("Category not available for " + page.getUid());
			}
		}
	...
	{
		return createFieldValues(indexedProperty, category.getCode());
	}
