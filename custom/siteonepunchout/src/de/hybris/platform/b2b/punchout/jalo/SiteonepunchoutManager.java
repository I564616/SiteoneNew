...
/**
 * This is the extension manager of the Siteonepunchout extension.
 */
public class SiteonepunchoutManager extends GeneratedSiteonepunchoutManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SiteonepunchoutManager.class);
	 ...
	 */
	public static SiteonepunchoutManager getInstance()
	{
		return (SiteonepunchoutManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SiteonepunchoutConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SiteonepunchoutManager() // NOPMD 
	{
		LOG.debug("constructor of SiteonepunchoutManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SiteonepunchoutManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SiteonepunchoutManager called, current tenant: {}", getTenant().getTenantID());
	}
