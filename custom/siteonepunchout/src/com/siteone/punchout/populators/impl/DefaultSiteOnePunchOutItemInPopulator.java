 ...
 */
public class DefaultSiteOnePunchOutItemInPopulator implements Populator<AbstractOrderEntryModel, ItemIn>
{
	...
	public void populate(final AbstractOrderEntryModel orderEntry, final ItemIn itemIn) throws ConversionException
	{
		...
		ProductModel p = orderEntry.getProduct();
		...
		description.setvalue(orderEntry.getProduct().getProductShortDesc());
