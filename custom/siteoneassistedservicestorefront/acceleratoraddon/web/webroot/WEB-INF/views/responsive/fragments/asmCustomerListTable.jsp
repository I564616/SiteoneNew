...
<spring:url value="/assisted-service/emulate/?customerId=" var="emulateCustomerUrl" htmlEscape="true"/>
                    ...
                    <table class="table techne-table">
                        ...
                        <tbody>
					     ...
					     <c:choose>
                                            ...
                                            <a href="${emulateCustomerUrl}${customer.uid}&fwd=${frowardUrl}/${customer.unit.reportingOrganization.uid}" class="responsive-table-link">
