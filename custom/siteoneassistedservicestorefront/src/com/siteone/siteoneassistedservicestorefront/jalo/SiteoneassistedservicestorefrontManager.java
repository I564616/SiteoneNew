...
/**
 * This is the extension manager of the Siteoneassistedservicestorefront extension.
 */
public class SiteoneassistedservicestorefrontManager extends GeneratedSiteoneassistedservicestorefrontManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SiteoneassistedservicestorefrontManager.class.getName());
	 ...
	 */
	public static SiteoneassistedservicestorefrontManager getInstance()
	{
		return (SiteoneassistedservicestorefrontManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SiteoneassistedservicestorefrontConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SiteoneassistedservicestorefrontManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SiteoneassistedservicestorefrontManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SiteoneassistedservicestorefrontManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SiteoneassistedservicestorefrontManager called, current tenant: " + getTenant().getTenantID());
		}
	}
