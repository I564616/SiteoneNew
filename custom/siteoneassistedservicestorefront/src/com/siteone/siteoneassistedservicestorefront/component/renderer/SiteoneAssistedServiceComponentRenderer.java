 ...
 *
 */
package com.siteone.siteoneassistedservicestorefront.component.renderer;
...
public class SiteoneAssistedServiceComponentRenderer<C extends AbstractCMSComponentModel> extends DefaultAddOnCMSComponentRenderer<C>
{

	private final static Logger LOG = Logger.getLogger(SiteoneAssistedServiceComponentRenderer.class);
	...
	public void renderComponent(final PageContext pageContext, final C component) throws ServletException, IOException
	{
		...
		if (asmSessionStatus || getAssistedServiceFacade().isAssistedServiceAgentLoggedIn())
		{
			...
			final String asmModuleView = "/WEB-INF/views/addons/siteoneassistedservicestorefront" + "/"
