...
public class DefaultSiteonecmsfacadesService implements SiteonecmsfacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSiteonecmsfacadesService.class);
	...
	{
		return DefaultSiteonecmsfacadesService.class.getResourceAsStream("/siteonecmsfacades/sap-hybris-platform.png");
	}
