...
public class DefaultSiteonepricefactoryService implements SiteonepricefactoryService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSiteonepricefactoryService.class);
	...
	{
		return DefaultSiteonepricefactoryService.class.getResourceAsStream("/siteonepricefactory/sap-hybris-platform.png");
	}
